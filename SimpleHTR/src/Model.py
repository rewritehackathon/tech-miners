...
class Model: 
    ...
    def setupCTC(self):
        ...
        if self.decoderType == DecoderType.BestPath:
            ...
            wordChars = open('/Users/mahzadkhoshlessan/Desktop/SimpleHTR/model/wordCharList.txt').read().splitlines()[0]
            corpus = open('/Users/mahzadkhoshlessan/Desktop/SimpleHTR/data/corpus.txt').read()
    ...
    def setupTF(self):
        ...
        modelDir = '/Users/mahzadkhoshlessan/Desktop/SimpleHTR/model'
    ...
    def save(self):
        "save model to file"
        self.snapID += 1
        self.saver.save(self.sess, '/Users/mahzadkhoshlessan/Desktop/SimpleHTR/model/snapshot', global_step=self.snapID)
